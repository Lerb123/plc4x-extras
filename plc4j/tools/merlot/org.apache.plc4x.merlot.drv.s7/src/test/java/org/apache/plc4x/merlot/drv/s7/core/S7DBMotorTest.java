...
public class S7DBMotorTest {
    ...
    public void DBRecordTest() {
        ...
        logger.info(String.format("Prueba en Motor:\n (bPB_Forward esperado: true == (bPB_Forward actual): %b)", bPB_Forward.get()));
        assertEquals(true, bPB_Forward.get());
        logger.info(String.format("Prueba en Motor:\n (bPB_Reverse esperado: true == (bPB_Reverse actual): %b)", bPB_Reverse.get()));
        assertEquals(true, bPB_Reverse.get());
        logger.info(String.format("Prueba en Motor:\n (bPB_Stop esperado: true == (bPB_Stop actual): %b)", bPB_Stop.get()));
        ...
        logger.info(String.format("Prueba en Motor:\n (bPBEN_Forward esperado: true == (bPBEN_Forward actual): %b)", bPBEN_Forward.get()));
        assertEquals(true, bPBEN_Forward.get());
        logger.info(String.format("Prueba en Motor:\n (bPBEN_Reverse esperado: true == (bPBEN_Reverse actual): %b)", bPBEN_Reverse.get()));
        assertEquals(true, bPBEN_Reverse.get());
        logger.info(String.format("Prueba en Motor:\n (bPBEN_Stop esperado: true == (bPBEN_Stop actual): %b)", bPBEN_Stop.get()));
        assertEquals(true, bPBEN_Stop.get());
        logger.info(String.format("Prueba en Motor:\n (bForwardOn esperado: true == (bForwardOn actual): %b)", bForwardOn.get()));
        assertEquals(true, bForwardOn.get());
        logger.info(String.format("Prueba en Motor:\n (bReverseOn esperado: true == (bReverseOn actual): %b)", bReverseOn.get()));
        assertEquals(true, bReverseOn.get());
        logger.info(String.format("Prueba en Motor:\n (bSignalForward esperado: true == (bSignalForward actual): %b)", bSignalForward.get()));
        assertEquals(true, bSignalForward.get());
        logger.info(String.format("Prueba en Motor:\n (bSignalReverse esperado: true == (bSignalReverse actual): %b)", bSignalReverse.get()));
        ...
        logger.info(String.format("Prueba en Motor:\n (bMotorProtectorTripped esperado: true == (bMotorProtectorTripped actual): %b)", bMotorProtectorTripped.get()));
        assertEquals(true, bMotorProtectorTripped.get());
        logger.info(String.format("Prueba en Motor:\n (bLocalDisconnectOff esperado: true == (bLocalDisconnectOff actual): %b)", bLocalDisconnectOff.get()));
        assertEquals(true, bLocalDisconnectOff.get());
        logger.info(String.format("Prueba en Motor:\n (bClutchTripped esperado: true == (bClutchTripped actual): %b)", bClutchTripped.get()));
        assertEquals(true, bClutchTripped.get());
        logger.info(String.format("Prueba en Motor:\n (bNoSignalForward esperado: true == (bNoSignalForward actual): %b)", bNoSignalForward.get()));
        assertEquals(true, bNoSignalForward.get());
        logger.info(String.format("Prueba en Motor:\n (bNoSignalReverse esperado: true == (bNoSignalReverse actual): %b)", bNoSignalReverse.get()));
        assertEquals(true, bNoSignalReverse.get());
        logger.info(String.format("Prueba en Motor:\n (bMotorNotStopped esperado: true == (bMotorNotStopped actual): %b)", bMotorNotStopped.get()));
